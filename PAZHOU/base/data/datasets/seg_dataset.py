...
class Dataset(paddle.io.Dataset):
    ...
    def __init__(self,
        ...
        if not os.path.exists(self.dataset_root):
            raise ValueError('there is not `dataset_root`: {}.'.format(
                self.dataset_root))
        ...
        if self.mode == 'train':
            if train_path is None:
                ...
                raise ValueError('`train_path` is not found: {}'.format(
                    train_path))
            else:
            ...
            if val_path is None:
                ...
                raise ValueError('`val_path` is not found: {}'.format(
                    val_path))
            else:
                file_path = val_path
        else:
            if test_path is None:
                ...
                raise ValueError('`test_path` is not found: {}'.format(
                    test_path))
            else:
                file_path = test_path
