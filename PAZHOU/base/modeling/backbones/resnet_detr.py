...
def build_resnet_detr_lazy(pretrain=False, pretrain_path='', depth=50, norm_type='bn', freeze_at=0, 
    return_idx=[3], lr_mult_list=[0.0, 0.1, 0.1, 0.1], num_stages=4, **kwargs):
    """
    Create a resnet instance from config
    """
    model = ResNet(depth=depth, norm_type=norm_type, freeze_at=freeze_at, return_idx=return_idx, 
        lr_mult_list=lr_mult_list, num_stages=num_stages)
